...
# Pre-initialize vertexai to prevent DefaultCredentialsError on import
try:
    vertex_project = os.environ.get("GOOGLE_CLOUD_PROJECT") or "mock-project"
...
class AgentEngineApp(AdkApp):
    def project_id(self) -> str:
        """Returns the project ID, bypassing resource manager check to support offline/mock credentials."""
        project = self._tmpl_attrs.get("project")
        if project and project != "your_google_cloud_project_id":
            return project
        return "mock-project"
...
agent_runtime = AgentEngineApp(
    ...
    instrumentor_builder=lambda project_id: None,
)
